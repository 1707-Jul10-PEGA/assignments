...
public class Driver {
    ...
    private static void firstChoice(Scanner scan) {
    ...
    private static void existingUser(Scanner scan) {
	boolean running = true;
	while (running) {
	    String name = "";
	    Integer id = 0;
    ...
    private static void userActions(Scanner scan) {
    ...
    private static void employeeActions(Scanner scan) {
	boolean running = true;
	while (running) {
	    String str = "";
		...
		Application application = ListManager.getApplication();
		// Customer customer =
		// ListManager.getCustomer(application.getCustomer().getName());
		// application = customer.getApplication();
		Log.info(application);
		if (application != null) {
		    System.out.println(application.getCustomer().toString());
		    boolean running2 = true;
		    while (running2) {
			...
			case "A":
			case "APPROVE":
			    System.out.println("Application approved for " + application.getCustomer().getName());
			    ((Employee) user).approve(application);
			    running2 = false;
			    break;
			case "D":
			case "DENY":
			    System.out.println("Application denied for " + application.getCustomer().getName());
			    ((Employee) user).deny(application);
			    running2 = false;
			    break;
			default:
	...
	System.out.println("Coming Soon in 1.1a");
