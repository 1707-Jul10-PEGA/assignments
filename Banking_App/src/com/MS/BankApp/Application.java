...
public class Application implements Serializable{
	...
	/*
	 * Generates filler data and creates all present admins/employees/customers. Also
	 * generates a few starter accounts with assorted values present.
	 */
