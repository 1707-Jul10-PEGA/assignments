...
public class Test {
	...
	public static void setUpBeforeClass(){
		admin = new Administrator("Jerry", "House", 34, "2234567890", "123 Maven Road", "jhouse", "jh123", -1);
	}
	...
	public void testApplicationEquals() {
		app = new Application(admin,"saving",2400.00,1);
		assertTrue(app.equals(new Application(admin,"saving",2400.00,1)));
	}
